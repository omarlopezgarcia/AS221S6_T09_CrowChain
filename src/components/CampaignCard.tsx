...
export const CampaignCard: React.FC<CampaignCardProps> = ({ campaignAddress }) => {
    ...
    // Get Campaign Description
    const {data: campaignImgUrl} = useReadContract({
        contract: contract,
    ...
    return (
            ...
            <img src={campaignImgUrl} alt="Campaign Image" />
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-white">{campaignName}</h5>
                    
                    <p className="mb-3 font-normal text-gray-200 dark:text-gray-400">{campaignDescription}</p>
                </div>
